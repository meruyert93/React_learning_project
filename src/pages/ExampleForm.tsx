...
export class ExampleForm extends Component <{}, {}> {
    ...
    render() {
        ...
        const birthDateInputField: InputField = {type: "date", placeholder: "Enter your birth date", label:"Birth date", fieldType: undefined}
        ...
        const radio1InputField: InputField = {type: "radio", placeholder: "Female", label:"Female", fieldType: undefined}
