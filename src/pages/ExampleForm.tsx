...
export class ExampleForm extends Component <{}, {}> {
    ...
    render() {
        ...
        const passwordInputField: PasswordGroupField = {type: "password-group", placeholder: "Create your password", label: ["Password (6 or more characters)", "Password Confirmation"]}
